...
<form action="{{URL::to('./insertdata')}}" enctype="multipart/form-data" method="post" data-parsley-validate>
	{{ csrf_field() }}
	<div class="postttt">
		<div class="post">
			<div class="top-post">
				...
				<div class="displaypost tablepost">
					<table>
						...
						<tr>
							...
							<td>
								<input type="hidden" name="category_post" value="" id="hddanhmuc" required="">
