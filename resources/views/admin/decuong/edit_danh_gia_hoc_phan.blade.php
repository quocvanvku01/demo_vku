...
<div class="danh-gia-hoc-phan">
	...
	<form action="{{URL::to('edit-danh-gia-hoc-phan/'.$id_decuong)}}" method="post">
		{{ csrf_field() }}
		<table border="1px" cellspacing="0" class="table-danh-gia-hoc-phan" style="margin-bottom: 100px">
			<thead>
				<tr>
					<td>Thành phần ĐG</td>
					<td>Bài đánh giá</td>
